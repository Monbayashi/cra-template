...
export const classNames = {
  ...
  white: lintName(
    'border-gray-600 bg-gray-50 text-gray-700 hover:bg-gray-300 focus:bg-gray-300 focus:outline-none disabled:bg-gray-500',
  ),
  middle: lintName('py-1 px-3'),
  small: lintName('py-1 px-2 text-sm'),
  full: lintName('w-full sm:w-auto py-1 px-3'),
} as const;
